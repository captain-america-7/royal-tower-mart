    ...
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-background">
      ...
      <div className="hero-content relative z-20 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-xl">
          ...
          <button className="hero-cta group relative overflow-hidden rounded-full border border-border px-8 h-14 font-medium text-foreground transition-all hover:bg-white/5 w-full sm:w-auto min-w-[200px] text-center flex items-center justify-center" data-magnetic>
